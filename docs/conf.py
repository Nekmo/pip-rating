...
# -*- coding: utf-8 -*-
#
# requirements_rating documentation build configuration file, created by
...
htmlhelp_basename = 'requirements_ratingdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'requirements_rating.tex',
     u'requirements-rating Documentation',
     u'Nekmo', 'manual'),
]
